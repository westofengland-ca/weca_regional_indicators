# Chapter 02: Public Transport Connectivity

**Lead analyst:** HB  
**Priority:** Connecting the region through better public transport
...
|----|------|--------|-------------|---------|
| RI_2A1 | [Indicator name] | Planned | [Source] | [Annual/Quarterly] |
...
3. Run processing script: `scripts/R/02-transport/[script].R`
4. Output lands in `data/fact/` (committed)
5. Re-render chapter: `quarto render chapters/02-transport/index.qmd`
